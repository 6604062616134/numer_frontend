        ...
        <div className="flex">
            ...
            <div className="flex-1 p-6">
                ...
                <p className="text-justify mt-2">
                    In linear algebra, the matrix inversion is a process that finds the matrix that, when multiplied with the original matrix, gives the identity matrix. The matrix inversion is used to solve systems of linear equations, to find the determinant of a matrix, and to calculate the rank of a matrix. The matrix inversion is an important operation in many applications, such as computer graphics, physics, and engineering.
                </p>
